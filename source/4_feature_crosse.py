...
# alternative function for train linear regressor model:
...
def train_model_ftrl(learning_rate,
                     steps,
                     batch_size,
                     feature_columns,
                     training_examples,
                     training_targets,
                     validation_examples,
                     validation_targets) -> tf.estimator.LinearRegressor:
    """Trains a linear regression model.
...
# return num_buckets quantiles to pass to the tf function bucketized_column and create bucketized featured
...
def construct_feature_columns_binned():
    """Construct the TensorFlow Feature Columns.
...
if __name__ == "__main__":
    ...
    # train model without bucketizing(binned) features
    _ = train_model_ftrl(
        learning_rate=1.0,
        steps=500,
        batch_size=100,
    ...
    _ = train_model_ftrl(
        ...
        steps=500,
        batch_size=100,
        feature_columns=construct_feature_columns_binned(),
        training_examples=training_examples,
        training_targets=training_targets,
        validation_examples=validation_examples,
        validation_targets=validation_targets)
