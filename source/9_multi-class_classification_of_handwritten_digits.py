...
# Here, we'll make separate input functions for training and for prediction.
# We'll nest them in create_training_input_fn() and create_predict_input_fn(), respectively,
# so we can invoke these functions to return the corresponding _input_fns to pass to our .train() and .predict() calls.
...
# define linear prediction model with multiclass logistic prediction, multiple sigmoid
...
if __name__ == "__main__":
    ...
    # train the dnn (deep neural network) classifier
    ...
    # plot the weights of the first layer of our neural-network
